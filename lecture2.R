...
qbinom(0.1, size = n, prob = p ) #확률 변수 X의 값이 0일 경우 CDF가 0.09, 1일 경우 CDF가 0.35임, 0~0.09 미만은 0, 0.09부터 0.35미만까지는 1이 선택됨
qbinom(0.5, size = n, prob = p) #확률 변수 x의 값이 2일 경우 CDF가 0.68임. 0.35~0.68미만은 확률 변수의 값은 2가 선택됨
